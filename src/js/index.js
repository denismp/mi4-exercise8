...
class App extends React.Component {
   constructor(props){
      ...
      if(window.web3){ // NEW
         ...
         this.web3 = new Web3(new Web3.providers.HttpProvider("https://ropsten.infuria.io/v3/7d4a1308aa2d4a5bbc448aabb6433e57")); // address of infurio node.
      }
      ...
      this.state.ContractInstance = MyContract.at("0x835EFAd8ce6eF1eCD4dF635412Be6b52bc36D2B6")
